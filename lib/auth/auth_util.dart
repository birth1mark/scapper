...
DocumentReference? get currentUserReference => currentUser?.user != null
    ? UsersLoginRecord.collection.doc(currentUser!.user!.uid)
    : null;

UsersLoginRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UsersLoginRecord.getDocument(UsersLoginRecord.collection.doc(uid))
              .handleError((_) {}),
    )
